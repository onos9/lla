                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <h2 className="sc_title sc_title_regular text-center margin_bottom_mini">Meet Our Tutors</h2>
                            <div className="sc_team">
                                <div className="col-md-3 col-sm-6 margin_bottom_small">
                                    <div className="sc_team_item">
                                        <div className="sc_team_item_avatar">
                                            <img alt="stuff-2.jpg" src="img/team/stuff-2-370x370.jpg" />
                                        ...
                                        <div className="sc_team_item_info">
                                            <h3 className="sc_team_item_title">David Schwimmer</h3>
                                            <div className="sc_team_item_position theme_accent2">mentor</div>
                                            <ul className="sc_team_item_socials">
                                                <li>
                                ...
                                <div className="col-md-3 col-sm-6 margin_bottom_small">
                                    <div className="sc_team_item">
                                        <div className="sc_team_item_avatar">
                                            <img alt="stuff-3.jpg" src="img/team/stuff-3-370x370.jpg" />
                                            <div className="sc_team_item_description">
                                        ...
                                        <div className="sc_team_item_info">
                                            <h3 className="sc_team_item_title">Lisa Kudrow</h3>
                                            <div className="sc_team_item_position theme_accent2">teacher</div>
                                            <ul className="sc_team_item_socials">
                                                <li>
                                                    <a className="social_icons social_facebook" target="_blank" href="http://facebook.com">
                                                        <span />
                                ...
                                <div className="col-md-3 col-sm-6 margin_bottom_small">
                                    <div className="sc_team_item">
                                        <div className="sc_team_item_avatar">
                                            <img alt="stuff-4.jpg" src="img/team/stuff-4-370x370.jpg" />
                                            <div className="sc_team_item_description">
                                                Donec vestibulum elementum massa id tempor. Cras malesuada sapien mauris, quis tincidunt metus euismod sit amet. Pellentesque tempor volutpat leo, eget bibendum risus mattis et
                                            </div>
                                        </div>
                                        <div className="sc_team_item_info">
                                            <h3 className="sc_team_item_title">Matt LeBlanc</h3>
                                            <div className="sc_team_item_position theme_accent2">teacher</div>
                                            <ul className="sc_team_item_socials">
                                                <li>
                                                    <a className="social_icons social_facebook" target="_blank" href="http://facebook.com">
                                ...
                                <div className="col-md-3 col-sm-6 margin_bottom_small">
                                    <div className="sc_team_item">
                                        <div className="sc_team_item_avatar">
                                            <img alt="stuff-3.jpg" src="img/team/stuff-1-370x370.jpg" />
                                            <div className="sc_team_item_description">
                                                Cras sodales, justo et rutrum consequat, elit magna semper augue, quis viverra velit orci quis diam. Sed vestibulum porta tellus, sed cursus velit laoreet non.
                                            </div>
                                        </div>
                                        <div className="sc_team_item_info">
                                            <h3 className="sc_team_item_title">Matthew Perry</h3>
                                            <div className="sc_team_item_position theme_accent2">teacher</div>
                                            <ul className="sc_team_item_socials">
                                                <li>
                                                    <a className="social_icons social_facebook" target="_blank" href="http://facebook.com">
                            ...
                            <div className="sc_line sc_line_style_shadow margin_bottom_mini" />
                            <div className="row">
                                <div className="col-md-8 col-sm-12">
                                    <div className="sc_skills sc_skills_arc margin_bottom_mini inited" data-type="arc" data-subtitle="Skills">
                                        <div className="sc_skills_legend">
                                            <h2>Web skills</h2>
                                            <ul>
                                                <li>JavaScript</li>
                                                <li>CSS3</li>
                            ...
                            <div className="row">
                                ...
                                <div className="sc_skills sc_skills_counter sc_skills_counter_5" data-type="counter" data-subtitle="Skills">
                                    <div className="columnsWrap sc_skills_columns">
