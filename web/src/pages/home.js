                    ...
                    <div className="row">
                        <div className="col-md-9 col-sm-12">
                            <div className="row">
                                        ...
                                        <div id="multi_slider_left" className="sc_slider sc_slider_swiper sc_slider_controls sc_slider_nopagination swiper-container slider-left">
                                            <div className="slides swiper-wrapper">
                                                <div className="swiper-slide">
                                                    ...
                                                    </a><div className="sc_slider_info content-slide"><a href="#" title="Morbi eget rutrum">
                                                    </a><a href="#" title="Morbi eget rutrum">
                                                        </a><div className="sc_slider_category"><a href="#" title="Morbi eget rutrum">
                                                        </a><a href="#" title="Morbi eget rutrum">
                                                            </a><a href="#">News demo</a>
                                                        </div>
                                                ...
                                                <div className="swiper-slide">
                                                    ...
                                                    </a><div className="sc_slider_info content-slide"><a href="#" title="Nulla ut dictum est">
                                                    </a><a href="#" title="Nulla ut dictum est">
                                                        </a><div className="sc_slider_category"><a href="#" title="Nulla ut dictum est">
                                                        </a><a href="#" title="Nulla ut dictum est">
                                                            </a><a href="#">News demo</a>
                                                        </div>
                                                        <div className="sc_slider_reviews reviews_summary blog_reviews after_category">
                                                ...
                                                <div className="swiper-slide">
                                                    ...
                                                    </a><div className="sc_slider_info content-slide"><a href="#" title="Phasellus pulvinar">
                                                    </a><a href="#" title="Phasellus pulvinar">
                                                        </a><div className="sc_slider_category"><a href="#" title="Phasellus pulvinar">
                                                        </a><a href="#" title="Phasellus pulvinar">
                                                            </a><a href="#">News demo</a>
                                                        </div>
                                                        <div className="sc_slider_reviews reviews_summary blog_reviews after_category">
                                                ...
                                                <div className="swiper-slide">
                                                    ...
                                                    </a><div className="sc_slider_info content-slide"><a href="#" title="Cras pulvinar sodales">
                                                    </a><a href="#" title="Cras pulvinar sodales">
                                                        </a><div className="sc_slider_category"><a href="#" title="Cras pulvinar sodales">
                                                        </a><a href="#" title="Cras pulvinar sodales">
                                                            </a><a href="#">News demo</a>
                                                        </div>
                                                        <div className="sc_slider_reviews reviews_summary blog_reviews after_category">
                                            ...
                                            <ul className="flex-direction-nav">
                                                <li>
                                                    ...
                                                    </a></li><a className="flex-prev" href="#">
                                                </a><li><a className="flex-prev" href="#">
                                                </a><a className="flex-next" href="#">
                                                    </a></li><a className="flex-next" href="#">
                                                </a></ul><a className="flex-next" href="#">
                                            </a></div><a className="flex-next" href="#">
                                ...
                                </a><div className="sc_line sc_line_style_shadow margin_top_big"><a className="flex-next" href="#">
                                </a><div className="row"><a className="flex-next" href="#">
                                </a><div className="col-md-6 col-sm-12"><a className="flex-next" href="#">
                                </a><div className="sc_tabs sc_tabs_style_2" data-active="{0}"><a className="flex-next" href="#">
                                </a><ul className="sc_tabs_titles" role="tablist"><a className="flex-next" href="#">
                                </a><li className="tab_names" role="tab"><a className="flex-next" href="#">
                                </a><a href="#tab5_popular" className="theme_button" id="tab4_tab">POPULAR</a>
                                                    </li>
                                                                        ...
                                                                        <tr>
                                                                            <th className="prevMonth">
                                                                                <div className="left roundButton">
                                                                                    ...
                                                                                    </a></div><a href="#" data-type="post" data-year="{2014}" data-month="{5}" title="View posts for May 2014">
                                                                                </a></th>
