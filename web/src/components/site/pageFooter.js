...
const PageFooter = () => {
    return (
        <section className="footerContentWrap">
                    ...
                    <div className="row columnsWrap">
                        <aside className="col-md-3 col-sm-6 widgetWrap widget widget_advert">
                            <div className="widget_advert_inner">
                                ...
                                <br />
                                <div className="sc_video_player" data-width="100%" data-height={150} data-last-width={220} style={{ height: 124 }}>
                                    <div className="sc_video_frame sc_video_play_button inited" data-video="<iframe class=&quot;video_frame&quot; src=&quot;http://www.youtube.com/embed/636Dp8eHWnM?autoplay=1&quot; width=&quot;100%&quot; height=&quot;150&quot; frameborder=&quot;0&quot; webkitAllowFullScreen=&quot;webkitAllowFullScreen&quot; mozallowfullscreen=&quot;mozallowfullscreen&quot; allowFullScreen=&quot;allowFullScreen&quot;></iframe>" style={{ opacity: 1 }}>
                                        <img alt src="img/portfolio16x9_13-212x150.jpg" style={{ height: 124 }} />
                                    </div>
                                </div>
                                <br />
                                <span className="sc_icon fa fa-home" />
                                378 Main Street London England
                                <br />
                                <span className="sc_icon fa fa-envelope" />
                                info@themerex.net
                                <br />
                                <span className="sc_icon fa fa-phone" />
                                +1 (44) 123-45-67
                            </div>
                        </aside>
